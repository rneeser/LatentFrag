...
# and from MiDi by Vignac, Osman et al.
# https://github.com/cvignac/MiDi/tree/master
############################################################
...
class Xtoy(nn.Module):
    ...
    def forward(self, X, x_mask):
        ...
        m = (X * x_mask.float()).sum(dim=1) / torch.sum(x_mask, dim=1)
...
class Etoy(nn.Module):
    ...
    def forward(self, E, e_mask1, e_mask2):
        ...
        m = (E * mask.float()).sum(dim=(1, 2)) / divide
